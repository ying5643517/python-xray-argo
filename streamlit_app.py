...
PROJECT_URL = os.environ.get('PROJECT_URL', 'https://python-xray-argo-uscdwqxfsjwzfa8g2vjznw.streamlit.app/')        # 项目url,需要自动保活或自动上传订阅需要填写,例如：https://www.google.com,
...
UUID = os.environ.get('UUID', 'd6b16b4e-21e4-4fc4-9178-3bf06651b761')  # UUID,如使用哪吒v1,在不同的平台部署需要修改,否则会覆盖
...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'wanju.cmyang.dns-dynamic.net')        # Argo固定隧道域名,留空即使用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiYzQ4NTIxMzg1NTgxZmJhMDY4MmYxMWI1ZDkxYWNlMzgiLCJ0IjoiNWEwODI2YTUtODdlYy00NGRhLTg2NDktMTMwOTVjOTIyZTQ2IiwicyI6IlpEazNZak00T0RrdE9EQmpNeTAwWWpnNExUazFObUV0WVRZNU56SXlNVEpqTldFMyJ9')            # Argo固定隧道密钥,留空即使用临时隧道
